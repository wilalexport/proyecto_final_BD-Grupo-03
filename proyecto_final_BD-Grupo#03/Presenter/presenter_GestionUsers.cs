...
namespace proyecto_final_BD_Grupo_03.Presenter
{
    public class presenter_GestionUsers
    {
        ...
        public void MostrarUsuarios(DataGridView dataGridView)
        {
            ...
            {
                dataGridView.Rows.Add(usuario.id_usuario, usuario.id_rol, usuario.id_departamento, usuario.name, usuario.username, usuario.password, usuario.email);
            }
        }
